...
<header class="header fixed-top">
   ...
   <div class="container">
      ...
      <div class="row align-items-center justify-content-between">
         ...
         <a href="#home" class="logo">Blood<span>Donation.</span></a>
         ...
         <a href="#contact" class="link-btn">Register</a>
   ...
   <div class="container">
      ...
      <div class="row min-vh-100 align-items-center">
         <div class="content text-center text-md-left">
            <h3>RED</h3>
            <p>THis is the blood donation sight where you can donate blood and save lives.</p>
   ...
   <div class="container">
      ...
      <div class="row align-items-center">
         ...
         <div class="col-md-6 image">
            <img src="image2.jpg" class="w-100 mb-5 mb-md-0" alt="">
         </div>
